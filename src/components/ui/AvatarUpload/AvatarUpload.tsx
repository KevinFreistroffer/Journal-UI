      ...
      <DropdownMenu.Root>
        <DropdownMenu.Trigger asChild>
          <div className="mb-4 cursor-pointer relative group">
            ...
            {clickableAvatar && (
              <div className="text-xs flex items-center gap-1 absolute bottom-[10%] left-0 bg-white dark:bg-[var(--color-darker1)] rounded-sm p-1 shadow-md border border-gray-300 dark:border-gray-700">
                <Pencil1Icon
                  className={`${
                    size
        ...
        {clickableAvatar && (
          <DropdownMenu.Portal>
            <DropdownMenu.Content className="relative top-[-7px] pt-[.125rem] bg-[var(--color-darker1)] rounded-lg shadow-md border border-gray-300 dark:border-gray-700 min-w-[150px] text-sm outline-none before:content-[''] before:absolute before:top-[-5px] before:left-[10px] before:w-[10px] before:h-[10px] before:rotate-45 before:border-l before:border-t before:border-gray-300 dark:before:border-gray-700 before:bg-[var(--color-darker1)] dark:before:bg-[var(--color-darker5)]">
              <DropdownMenu.Item
                className="text-xs px-4 py-2 relative z-10 pb-1 outline-none cursor-pointer hover:bg-gray-100 dark:hover:bg-[var(--color-darker4)] dark:text-gray-200 rounded rounded-bl-none rounded-br-none text-gray-700 border-b border-gray-300 dark:border-gray-700"
                onSelect={handleUploadClick}
              >
                Upload a photo
              </DropdownMenu.Item>
              <DropdownMenu.Item
                className="text-xs px-4 py-2 outline-none cursor-pointer hover:bg-gray-100 dark:hover:bg-[var(--color-darker4)] rounded rounded-tl-none rounded-tr-none text-red-500 dark:text-red-400"
